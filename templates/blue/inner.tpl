...
<!-- <form name="frmSer" method="post" action="{makeLink mod=product pg=search newurl='true' sslval='false' storename=$smarty.request.storename}act=result{/makeLink}" style="margin:0px; ">	
 --><form name="frmSer" method="post" action="{makeLink mod=product pg=search sslval='true'}act=result{/makeLink}" style="margin:0px; ">	
...
<li><a href="{makeLink mod=product pg=list url_encode=1}act=pg_list&cat_id={$row->category_id}{/makeLink}"><img src="{$GLOBAL.tpl_url}/images/dot.jpg" width="11" height="10" border="0">&nbsp;{$row->category_name}</a></li>
 {/foreach}
 <li><a href="{makeLink mod=product pg=list url_encode=1}act=other_gifts&cat_id=306{/makeLink}"><img src="{$GLOBAL.tpl_url}/images/dot.jpg" width="11" height="10" border="0">&nbsp;Other Gifts</a></li>
</ul>
</ul>
<img src="{$GLOBAL.tpl_url}/images/special-occasions-bottom.jpg" width="185" align="absbottom">
	...
	<div id="popupContact" style="display:none;">
			...
			<img src="{$GLOBAL.tpl_url}/images/loading06.gif" width="400" height="192"/>

      ...
      <table width="400" height="200" border="0" cellpadding="4" cellspacing="0" class="naBrdr">
        ...
        <tr>
          ...
          <td>
            ...
            <input type="hidden" name="store_id" value="{$STORE_ID}">			</td>
        </tr>
        <tr>
          <td align="right">&nbsp;</td>
        ...
        <tr>
          <td colspan="2" align="center">Forgot your Password? <a href="{makeLink mod=store pg=member_pswd}{/makeLink}" class="footerlink"><u>Click here</u></a></td>
          </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>

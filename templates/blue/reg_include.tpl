...
function validHeading1(val,type)
{
		...
		req1.open("POST", "{makeLink mod=member pg=ajax_registration}act=valid_heading1{/makeLink}&"+Math.random());
		{literal}
		req1.setRequestHeader("Content-Type","application/x-www-form-urlencoded; charset=UTF-8");
		req1.send(str);
}
...
function validHeading2(val,type)
{
		...
		req1.open("POST", "{makeLink mod=member pg=ajax_registration}act=valid_heading2{/makeLink}&"+Math.random());
		{literal}
		req1.setRequestHeader("Content-Type","application/x-www-form-urlencoded; charset=UTF-8");
		req1.send(str);
}

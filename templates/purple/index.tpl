...
<link href="{$GLOBAL.tpl_url}/css/style_old.css" rel="stylesheet" type="text/css">
...
<table width="880"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr valign="top">
    ...
    <td align="left" valign="top" height="100%">{if file_exists("`$smarty.const.SITE_PATH`/templates/`$GLOBAL.curr_tpl`/left.tpl")}{include file="`$smarty.const.SITE_PATH`/templates/`$GLOBAL.curr_tpl`/left.tpl"}{/if}</td>

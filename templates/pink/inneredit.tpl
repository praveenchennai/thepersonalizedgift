...
<br/><div class="storehead2" align="right">{$WELCOME_MESSAGE_STORE.heading2}</div></div>{/if}</div>
	   ...
	   <div class="innerlogin">
			   ...
			   <div style="vertical-align:bottom; padding-top:10px; padding-bottom:2px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{$MOD_VARIABLES.MOD_COMM.COMM_CMN_USERNAME_TOP}&nbsp;&nbsp;
			     <input name="txtuname" type="text" class="input" size="20" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{$MOD_VARIABLES.MOD_COMM.COMM_CMN_PASSWORD_TOP} &nbsp;<input name="txtpswd" type="password" class="input" size="20" />&nbsp;&nbsp;&nbsp;&nbsp;<input type="image" style="vertical-align:middle; " src="{$GLOBAL.tpl_url}/images/go.jpg" ></div>

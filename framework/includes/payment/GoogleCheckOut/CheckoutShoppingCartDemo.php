 ...
 * and to place a new order with the Cart XML through a HTML form.
 * 
 * Posting a cart requires the steps shown below:
 *   1. Create a shopping cart for the buyer's items as an XML 
 *          structure, <checkout-shopping-cart> XML.

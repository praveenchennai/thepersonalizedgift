...
//
//  Dick Munroe (munroe@csworks.com) 28-Mar-2006
//      Scalars were being emitted without newlines unlike all
//      the structured variables.  Make this consistent so that
//      the newline function can be used consistently.
//
  ...
  function scalar(&$theVariable, $theHtmlFlag)
    {
      if ($theHtmlFlag)
        {
          return "<pre>" . preg_replace('|<|s', '&lt;', var_export($theVariable, true)) . "</pre><br />" ;
        }
      else
        {

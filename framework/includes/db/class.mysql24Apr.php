...
class DB
{
    ...
    function get_results_pagewise($query=null, $page, $limit = 20, $params='', $output=OBJECT, $orderBy='',$type='', $pageVarName="pageNo") {
        if ( $query ) {
            ...
            $str 		= "Page $page / $numpages&nbsp; &nbsp;<font color=black>|</font>&nbsp; &nbsp;Matching Records : $count&nbsp; &nbsp;<font color=black>|</font>&nbsp; &nbsp;";
            if($page > 1) {
                $str .= '<a class="toplinkpagi" href="?sess='.base64_encode("$pageVarName=".($page-1).$params.'&limit='.$limit).'">&laquo; Prev</a> &nbsp;<font color=black>|</font> &nbsp;';
                $pre_link = "index.php?sess=".base64_encode("$pageVarName=".($page-1).$params.'&limit='.$limit);
            } else {
                $str .= "&laquo; Prev &nbsp;<font color=black>|</font> &nbsp;";
                $pre_link = "#";
            }
            ...
            if($page < $numpages) {
                $str .= '<font color=black>|</font> &nbsp;<a class="toplinkpagi" href="?sess='.base64_encode("$pageVarName=".($page+1).$params.'&limit='.$limit).'">Next &raquo;</a> &nbsp;';
				$str1 .= '<font color=black>|</font> &nbsp;<a class="toplinkpagi" href="?sess='.base64_encode("$pageVarName=".($page+1).$params.'&limit='.$limit).'">Next &raquo;</a> &nbsp;';
				$next_link = "index.php?sess=".base64_encode("$pageVarName=".($page+1).$params.'&limit='.$limit);
            } else {
			 	
                $str .= "<font color=black>|</font> &nbsp;Next &raquo;";
				if($numpages>0){
					$str1 .= "<font color=black>|</font> &nbsp;Next &raquo;";
				}
				$next_link = "#";
            }
            if($count == 0) {
	...
	{	
		...
		if ( $query ) {	
			...
			if($previous < 0){
				...
				if($numpadtype==1) {
					$anc .= "<a class='toplinkpagi' style='text-decoration:none' href='javascript:pagination($previous,$limit,$orderBy);void(0);'>Previous l </a>";
					if($page_showing>$norepeat+2)
					$anc .= "<a class='toplinkpagi' style='text-decoration:none' href='javascript:pagination(0,$limit,$orderBy);void(0);'>1... l </a>";
					else
					$anc .= "<a class='toplinkpagi' style='text-decoration:none' href='javascript:pagination(0,$limit,$orderBy);void(0);'>1 l </a>";
				}else {
					$anc .= "<a class='toplinkpagi' style='text-decoration:none' href='javascript:pagination(0,$limit,$orderBy);void(0);'>First l </a>";
					$anc .= "<a class='toplinkpagi' style='text-decoration:none' href='javascript:pagination($previous,$limit,$orderBy);void(0);'>Previous l </a>";
				}
				
				$pre_link = "<a class='toplinkpagi' style='text-decoration:none' href='javascript:pagination($previous,$limit,$orderBy);void(0);'>&lt;&lt;Previous </a>";
			}
			...
			for($i=$page_showing; $i>1; $i--){
				...
				if($numpadtype==1) {
					if($fpreviousPage!=1)
					$anch = "<a class='toplinkpagi' style='text-decoration:none' href='javascript:pagination($page,$limit,$orderBy);void(0);'>$fpreviousPage l </a>".$anch;
				}else{
					$anch = "<a class='toplinkpagi' style='text-decoration:none' href='javascript:pagination($page,$limit,$orderBy);void(0);'>$fpreviousPage l </a>".$anch;
				}
			...
			for($i=$page_showing; $i<$total_page; $i++){
				...
				if($numpadtype==1) {
					...
					$anc .= "<a class='toplinkpagi' style='text-decoration:none' href='javascript:pagination($page,$limit,$orderBy);void(0);'>$fnextPage l </a>";
				}else{
					$anc .= "<a class='toplinkpagi' style='text-decoration:none' href='javascript:pagination($page,$limit,$orderBy);void(0);'>$fnextPage l </a>";
				}
			...
			if($next >= $numrows){
				...
				if($numpadtype==1) {
					...
					$anc .= "<a class='toplinkpagi' style='text-decoration:none' href='javascript:pagination($last,$limit,$orderBy);void(0);'>$total_page l </a>";
					else 
					$anc .= "<a class='toplinkpagi' style='text-decoration:none' href='javascript:pagination($last,$limit,$orderBy);void(0);'>...$total_page l </a>";
					
					$anc .= "<a class='toplinkpagi' style='text-decoration:none' href='javascript:pagination($next,$limit,$orderBy);void(0);'>Next</a>";
				}else {
					$anc .= "<a class='toplinkpagi' style='text-decoration:none' href='javascript:pagination($next,$limit,$orderBy);void(0);'>Next l </a>";
					$anc .= "<a class='toplinkpagi' style='text-decoration:none' href='javascript:pagination($last,$limit,$orderBy);void(0);'>Last</a>";	
				}
				
				$next_link="<a class='toplinkpagi' style='text-decoration:none' href='javascript:pagination($next,$limit,$orderBy);void(0);'>Next&gt&gt;</a>";
			}
			...
			if ($numrows>0) {
				$arr = array(15=>15, 30=>30);  #, 45=>45, 60=>60, 90=>90, 150=>150,($numrows+1)=>All
           		$limitList = "<select id=numRecRes class=inputelement onchange='javascript:pagination(0,this.value,$orderBy);void(0);'>";

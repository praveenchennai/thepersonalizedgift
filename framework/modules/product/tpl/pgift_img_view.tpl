...
{literal}
	...
	<script type="text/javascript">
		...
		{
			document.getElementById('imageLoader').sendTextFromHtml('{/literal}{$smarty.const.SITE_URL}{literal}/modules/ajax_editor/images/{/literal}{$IMG_ID}{literal}.jpg');
		}
	</script>
...
</div><!--<div class="ic-w300 ic-cntr"><div ><center><img src="{$smarty.const.SITE_URL}/modules/ajax_editor/images/{$IMG_ID}.jpg"  border="0" align="middle" ></center></div><a class="ic-cp" href="javascript:;" ></a><div >

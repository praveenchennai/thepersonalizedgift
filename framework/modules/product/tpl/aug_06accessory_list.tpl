...
{if $STORE_PERMISSION.add == 'Y'}		  
		 ...
		 <a class="linkOneActive" href="#" onclick="javascript: document.frm_accessory.action='{makeLink mod=accessory pg=accessory}act=form&sId={$smarty.request.sId}&cat_id={$smarty.request.cat_id}&fId={$smarty.request.fId}&limit={$smarty.request.limit}&flag=1&mId={$MID}{/makeLink}'; document.frm_accessory.submit();">Duplicate {$smarty.request.sId}</a>
		  </td> 
{/if}
        </tr> 
      </table></td> 
  ...
  <tr> 
    <td><table width=100% border=0 cellpadding="2" cellspacing="0"> 
        ...
        <tr class="{cycle name=bg values="naGrid1,naGrid2"}">
          ...
          <td align="left"><a class="linkOneActive" href="{makeLink mod=$MOD pg=$PG}act=form&id={$accessory->id}&cat_id={$smarty.request.cat_id}&limit={$smarty.request.limit}&sId={$smarty.request.sId}&fId={$smarty.request.fId}&mId={$MID}{/makeLink}">{$accessory->name}</a></td>
...
<td align="left" width="100%"> <span class="group_style">Mass Updates</span></td>
  <td align="right" nowrap><strong>Append  to the existing </strong><input name="append" type="checkbox" id="append" value="Y" checked></td>
	  ...
	  {if $FIELDS.1==Y}
        ...
        <td valign=top>:</td>
        <td><select name="accessory_category[]" multiple size="20" style="width:250">
  ...
  <tr>
   ...
   <tr>
    ...
    <td colspan="3">&nbsp;<input type="checkbox" name="mass_field14" value="Y">&nbsp;Don't link Option to Products in these stores &nbsp;&nbsp;&nbsp;</td>
	
    </tr>
	<tr>
	<td colspan="3">&nbsp;<input type="checkbox" name="mass_field15" value="Y">&nbsp;Add to all product under selected category  &nbsp;&nbsp;&nbsp;</td>
	</tr>
</table>
    ...
    <tr class="naGridTitle"> 
      <td colspan=12 valign=center><div align=center> 
	      <input name="submit" type=submit value="Submit" class="naBtn" onClick="return chkval();" >&nbsp; 

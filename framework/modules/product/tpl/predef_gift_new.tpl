...
function popup()
{
	...
	w=window.open("{/literal}{makeLink mod=product pg=art_preview}act=preview&id={literal}"+acc_id+"{/literal}{/makeLink}{literal}", 'w', 'width=700,height=500,scrollbars=yes');
	w.focus();	
...
<form action="" method="post" enctype="multipart/form-data" name="frmGift" >
    ...
    <tr valign="middle" class="naGrid2">
	 ...
	 <tr  class="{cycle values="naGrid1,naGrid2"}">
			 ...
			 <tr valign="middle">
      <td width="300" height="25"  align="right"><span class="fieldname">Select a Poem:&nbsp;</span></td>
  ...
  <tr>
    ...
    <td><input type="button" class="naBtn" value="Select"  id="poem_sel_btn" onclick="w=window.open('{makeLink mod=product pg=accessory_popup}act=artbackground_list&aid=174{/makeLink}', 'w', 'width=700,height=500,scrollbars=yes');w.focus();" style="display:{if $POEM_DET}none{else}block{/if}; width:62px"  />
	...
	<tr>
      ...
      <td width="300" height="25"  align="right"><span class="fieldname">Select an Art Background:</span></td>
  ...
  <tr>
    ...
    <td><input id="art_sel_btn" type="button" class="naBtn" value="Select" onclick="w=window.open('{makeLink mod=product pg=accessory_popup}act=artbackground_list&aid=203{/makeLink}', 'w', 'width=700,height=500,scrollbars=yes');w.focus();" style="display:{if $ART_DET}none{else}block{/if}; width:62px"   />
	...
	<input id="art_cal_btn" style="display:{if $ART_DET}block{else}none{/if}" type="button" class="naBtn" value="Cancel " onclick="CancelArt();"  />
	 ...
	 <tr >
		<td  colspan="3"  ><div style="display:block" id="art_select"><table  width="100%" border="0" cellpadding="0" cellspacing="1">
		<tr valign="middle"  class="{cycle values="naGrid1,naGrid2"}">
      <td width="300" height="25"  align="right"><span class="fieldname">Select a Mat:</span></td>
      <td width="16" height="25"  >&nbsp;</td>
  ...
  <tr>
    ...
    <td><input id="mat_sel_btn" type="button" class="naBtn" value="Select" onclick="w=window.open('{makeLink mod=product pg=accessory_popup}act=artbackground_list&aid=235{/makeLink}', 'w', 'width=700,height=500,scrollbars=yes');w.focus();" style="display:{if $MAT_DET}none{else}block{/if}; width:62px"   />
	...
	<input id="mat_cal_btn" style="display:{if $MAT_DET}block{else}none{/if}"  type="button" class="naBtn" value="Cancel " onclick="CancelMat();"  />
	 ...
	 <tr>
		<td  colspan="3"  ><div style="display:block" id="art_select"><table  width="100%" border="0" cellpadding="0" cellspacing="1">
		<tr valign="middle"  class="{cycle values="naGrid1,naGrid2"}" >
      <td width="300" height="25"  align="right"><span class="fieldname">Select a Frame:</span></td>
      <td width="16" height="25"  >&nbsp;</td>
      <td width="423" height="25" >
	  <table width="90%" border="0" cellpadding="0"  cellspacing="0" >
  <tr>
    ...
    <td><input id="frame_sel_btn" type="button" class="naBtn" value="Select" onclick="w=window.open('{makeLink mod=product pg=accessory_popup}act=artbackground_list&aid=245{/makeLink}', 'w', 'width=700,height=500,scrollbars=yes');w.focus();"  style="display:{if $FRAME_DET}none{else}block{/if}; width:62px"   />

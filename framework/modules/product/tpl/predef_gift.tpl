...
function popup()
{
	...
	w=window.open("{/literal}{makeLink mod=product pg=art_preview}act=preview&id={literal}"+acc_id+"{/literal}{/makeLink}{literal}", 'w', 'width=740,height=680,scrollbars=yes');
	w.focus();	
...
function showFieldsByProduct(product_id,acc_id)
{
	...
	window.location.href='{/literal}{makeLink mod=product pg=index}act=predef_gift&id={$smarty.request.id}{/makeLink}{literal}&product_id='+frmGift.product_id.value+'&category='+document.frmGift.category.value+'&poem_id='+document.frmGift.poem_id.value+'&art_id='+document.frmGift.art_id.value+'&mat_id='+document.frmGift.mat_id.value+'&frame_id='+document.frmGift.frame_id.value+'&poem_id='+document.frmGift.poem_id.value+'&product_title='+document.frmGift.product_title.value+'&product_description='+document.frmGift.product_description.value+'&product_basic_price='+document.frmGift.product_basic_price.value+'&product_sale_price='+document.frmGift.product_sale_price.value;
...
<form action="" method="post" enctype="multipart/form-data" name="frmGift" >
    ...
    <tr align="left">
      <td colspan=3 valign=top><table width="100%" align="center">
        <tr>
          ...
          <td width="77%" align="right" nowrap class="titleLink">&nbsp;<a href="{makeLink mod=$smarty.request.mod pg=$smarty.request.pg}act=predef_gift_list{/makeLink}&store_id={$smarty.request.store_id}&sId={$smarty.request.sId}&fId={$smarty.request.fId}&mId={$MID}">List</a></td>
        </tr>
      </table></td>
    </tr>
	{if isset($MESSAGE)}
    ...
    <tr valign="middle" class="naGrid2">
	 ...
	 <tr  class="{cycle values="naGrid1,naGrid2"}">
			 ...
			 <tr valign="middle">
      <td width="270" height="25"  align="right"><span class="fieldname">Select a Poem:</span></td>
      <td width="16" height="25">&nbsp;</td>
      <td width="423" height="25" align="left">
  ...
  <tr>
    ...
    <td><input type="button" class="naBtn" value="Select"  id="poem_sel_btn" onclick="w=window.open('{makeLink mod=product pg=accessory_popup}act=artbackground_list&aid=174{/makeLink}', 'w', 'width=850,height=730,scrollbars=yes');w.focus();" style="display:{if $POEM_DET}none{else}block{/if}; width:62px"  />
	...
	<tr>
		<td  colspan="3"><div style="display:block" id="art_select"><table  width="100%" border="0" cellpadding="0" cellspacing="1"  >
		<tr valign="middle"  class="{cycle values="naGrid1,naGrid2"}" >
      <td width="270" height="25"  align="right"><span class="fieldname">Select an Art Background:</span></td>
      <td width="16" height="25" >&nbsp;</td>
  ...
  <tr>
    ...
    <td><input id="art_sel_btn" type="button" class="naBtn" value="Select" onclick="w=window.open('{makeLink mod=product pg=accessory_popup}act=artbackground_list&aid=203{/makeLink}', 'w', 'width=850,height=730,scrollbars=yes');w.focus();" style="display:{if $ART_DET}none{else}block{/if}; width:61px"   />
	...
	<input id="art_cal_btn" style="display:{if $ART_DET}block{else}none{/if}; width:61px" type="button" class="naBtn" value="Cancel " onclick="CancelArt();"  />
	 ...
	 <tr >
		<td  colspan="3"  ><div style="display:block" id="art_select"><table  width="100%" border="0" cellpadding="0" cellspacing="1">
		<tr valign="middle"  class="{cycle values="naGrid1,naGrid2"}">
      <td width="270" height="25"  align="right"><span class="fieldname">Select a Mat:</span></td>
      <td width="16" height="25"  >&nbsp;</td>
  ...
  <tr>
    ...
    <td><input id="mat_sel_btn" type="button" class="naBtn" value="Select" onclick="w=window.open('{makeLink mod=product pg=accessory_popup}act=artbackground_list&aid=235{/makeLink}', 'w', 'width=850,height=730,scrollbars=yes');w.focus();" style="display:{if $MAT_DET}none{else}block{/if}; width:62px"   />
	...
	<input id="mat_cal_btn" style="display:{if $MAT_DET}block{else}none{/if}"  type="button" class="naBtn" value="Cancel " onclick="CancelMat();"  />
	 ...
	 <tr>
		<td  colspan="3"  ><div style="display:block" id="art_select"><table  width="100%" border="0" cellpadding="0" cellspacing="1">
		<tr valign="middle"  class="{cycle values="naGrid1,naGrid2"}" >
      <td width="270" height="25"  align="right"><span class="fieldname">Select a Frame:</span></td>
      <td width="16" height="25"  >&nbsp;</td>
      <td width="423" height="25" >
	  <table width="90%" border="0" cellpadding="0"  cellspacing="0" >
  <tr>
    ...
    <td><input id="frame_sel_btn" type="button" class="naBtn" value="Select" onclick="w=window.open('{makeLink mod=product pg=accessory_popup}act=artbackground_list&aid=245{/makeLink}', 'w', 'width=850,height=730,scrollbars=yes');w.focus();"  style="display:{if $FRAME_DET}none{else}block{/if}; width:62px"   />
	...
	<tr>
		<td  colspan="3"  ><div style="display:block" id="art_select"><table  width="100%" border="0" cellpadding="0" cellspacing="1">
		<tr valign="middle"  class="{cycle values="naGrid1,naGrid2"}" >
      <td width="270" height="25"  align="right"><span class="fieldname">Wood Frame:</span></td>
      <td width="16" height="25"  >&nbsp;</td>
      <td width="423" height="25" >
	  <table width="90%" border="0" cellpadding="0"  cellspacing="0" >
  <tr>
    <td width="400"> <div id="woodframe_selected" style="float:left">&nbsp;{$WOODFRAME_DET.name}</div></td>
    <td><a href="#" onclick="showWoodFramePopup();" id="woodframe_preview" style="visibility:{if $WOODFRAME_DET}visible{else}hidden{/if};"><img src="{$GLOBAL.tpl_url}/images/grid/explore_next_level.gif" title="Preview" border="0" ></a></td>
    <td><input id="woodframe_sel_btn" type="button" class="naBtn" value="Select" onclick="w=window.open('{makeLink mod=product pg=accessory_popup}act=artbackground_list&aid=252{/makeLink}', 'w', 'width=850,height=730,scrollbars=yes');w.focus();"  style="display:{if $WOODFRAME_DET}none{else}block{/if}; width:62px"   />
	...
	<table border="0" cellpadding="0" cellspacing="1"  width="100%">
	 ...
	 <select name="gender" id="gender" style="width:200px">
	 	<option value="">-Select-</option>
	 	<option value="M" {if $smarty.request.gender eq 'M' } selected="selected"{/if}>Male</option>
...
<tr valign="middle"  class="{cycle values="naGrid1,naGrid2"}">
	...
	<tr valign="middle"  class="{cycle values="naGrid1,naGrid2"}">
	 ...
	 <select name="gender2" id="gender2" style="width:200px">
	 	<option value="">-Select-</option>
	 	<option value="M" {if $smarty.request.gender2 eq 'M' } selected="selected"{/if}>Male</option>

...
{/if}
   ...
   <td width="12%" align="center">&nbsp;Category&nbsp;:</td>
	  ...
	  <!--<select name=cat_id  style="width:250px"onchange="javascript: document.frm_accessory.action='{makeLink mod=accessory pg=accessory}act=settingsAddPop&limit={$smarty.request.limit}&sId={$smarty.request.sId}&fId={$smarty.request.fId}&mId={$MID}&group_id={$smarty.request.group_id}{/makeLink}&cat_id='+this.value;document.frm_accessory.submit();">
	...
	<select name=cat_id  style="width:185px"onchange="window.location.href='{makeLink mod=accessory pg=accessory}act=settingsAddPop&limit={$smarty.request.limit}&sId={$smarty.request.sId}&fId={$smarty.request.fId}&mId={$MID}&group_id={$smarty.request.group_id}{/makeLink}&cat_id='+this.value;document.frm_accessory.submit();">
        <option value="">-- SELECT A CATEGORY --</option>
	 { if $SELECT_DEFAULT ne '' }
	 <option value="" selected="selected">{$SELECT_DEFAULT}</option>
	 {/if}
  ...
  <tr> 
    <td><table width=100% border=0 cellpadding="2" cellspacing="0"> 
	    <tr>
          ...
          <td width="50%" align="left" nowrap class="naGridTitle">{makeLink mod=accessory pg=accessory orderBy=name display="Name" }act=settingsAddPop&sId={$smarty.request.sId}&cat_id={$smarty.request.cat_id}&group_id={$smarty.request.group_id}&fId={$smarty.request.fId}&mId={$MID} {/makeLink}</td> 
          <td width="15%" align="center" nowrap class="naGridTitle">{makeLink mod=accessory pg=accessory orderBy=type display="Type" }act=settingsAddPop&sId={$smarty.request.sId}&cat_id={$smarty.request.cat_id}&group_id={$smarty.request.group_id}&fId={$smarty.request.fId}&mId={$MID} {/makeLink}</td>
          <td width="15%" align="center" nowrap class="naGridTitle">{makeLink mod=accessory pg=accessory orderBy=adjust_price display="Adjust Price" }act=settingsAddPop&sId={$smarty.request.sId}&cat_id={$smarty.request.cat_id}&group_id={$smarty.request.group_id}&fId={$smarty.request.fId}&mId={$MID} {/makeLink}</td>
          <td width="15%" align="center" nowrap class="naGridTitle">{makeLink mod=accessory pg=accessory orderBy=adjust_weight display="Adjust Weight" }act=settingsAddPop&sId={$smarty.request.sId}&cat_id={$smarty.request.cat_id}&group_id={$smarty.request.group_id}&fId={$smarty.request.fId}&mId={$MID} {/makeLink}</td>
          <td width="20%" align="center" nowrap class="naGridTitle">{makeLink mod=accessory pg=accessory orderBy=active display="Active" }act=settingsAddPop&sId={$smarty.request.sId}&cat_id={$smarty.request.cat_id}&group_id={$smarty.request.group_id}&fId={$smarty.request.fId}&mId={$MID} {/makeLink}</td>
	    </tr>
	...
	<tr class="naGridTitle"> 
      <td colspan=2 valign=center><div align=center> 
	       <input type=submit value="Move to New Item" class="naBtn" name="btnMove" onClick="javascript: document.frm_accessory.action='{makeLink mod=accessory pg=accessory}act=settingsAddPop&limit={$smarty.request.limit}&sId={$smarty.request.sId}&fId={$smarty.request.fId}&mId={$MID}&group_id={$smarty.request.group_id}{/makeLink}&cat_id='+this.value;document.frm_accessory.submit();">&nbsp; 

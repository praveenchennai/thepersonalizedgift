...
<input type="hidden" id="remove" name="remove"  value=""/>
    <tr align="left">
      <td colspan=3 valign=top><table width="100%" align="center">
          <tr>
            ...
            <td nowrap align="right" class="titleLink"><a href="{makeLink mod=`$smarty.request.mod` pg=`$smarty.request.pg`}act=list{/makeLink}&sId={$SUBNAME}&mId={$MID}&fId={$smarty.request.fId}&category_id={$smarty.request.category_id}&limit={$smarty.request.limit}&pageNo={$smarty.request.pageNo}&product_search={$smarty.request.product_search}">{$smarty.request.sId} List</a></td>
          </tr>
      </table></td>
    </tr>
   <tr>
  ...
  {if $FIELDS.1==Y}
   {if $STOREFIELD.1!='H'}
  <tr class="naGrid1">
    <td valign="middle" width=40% align="right"><span class="fieldname">Name:</span></td>
   <td width="3"  align="center">&nbsp;</td>

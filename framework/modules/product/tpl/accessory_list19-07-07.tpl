...
{if $STORE_PERMISSION.add == 'Y'}		  
		  <a  href="{makeLink mod=$MOD pg=$PG}act=form&sId={$smarty.request.sId}&cat_id={$smarty.request.cat_id}&fId={$smarty.request.fId}&mId={$MID}&limit={$smarty.request.limit}{/makeLink}">Add New {$smarty.request.sId} </a>&nbsp;&nbsp;

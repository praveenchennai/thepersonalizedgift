...
$storeArr = $objStore->storeGetByName($_REQUEST['storename']);
				...
				if($objProduct->ValidateGiftCertificate($_REQUEST['product_id'],$_REQUEST['price']))
						...
						if($accessory_status['status']==true)
								...
								//redirect(makeLink(array("mod"=>"product","pg"=>"list"), "act=oderform&act1=3&oid=$odId"));
								echo "location.href='".makeLink(array("mod"=>"product","pg"=>"list"), "act=oderform&act1=3&oid=$odId")."';";
								}
							else
								{

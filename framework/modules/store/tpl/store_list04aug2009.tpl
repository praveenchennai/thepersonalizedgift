  ...
  <tr> 
    <td><table border=0 width=100% cellpadding="5" cellspacing="0"> 
        ...
        <tr>
          ...
          <td width="5%" nowrap class="naGridTitle" height="24" align="center"></td> 
          <td width="25%" nowrap class="naGridTitle" height="24" align="left">{makeLink mod=store pg=index orderBy="name" display="`$smarty.request.sId` URL"}act=list&sId={$smarty.request.sId}&fId={$smarty.request.fId}{/makeLink}</td> 
          <td width="25%" nowrap class="naGridTitle">{makeLink mod=store pg=index orderBy="heading" display="Name"}act=list&sId={$smarty.request.sId}&fId={$smarty.request.fId}{/makeLink}</td>
          <td width="5%" nowrap class="naGridTitle" align="center">{makeLink mod=store pg=index orderBy="active" display="Status"}act=list&sId={$smarty.request.sId}&fId={$smarty.request.fId}{/makeLink}</td>
		     <td  width="10%"  nowrap class="naGridTitle" align="center">Subscription</td>
        </tr>

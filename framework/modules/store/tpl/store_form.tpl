...
<form action="" method="post" enctype="multipart/form-data" name="subFrm">
    ...
    <tr> 
	  ...
	  <td width="417" align="right"><a href="{$smarty.const.SITE_URL}/{$STORE.name}"></a><a href="{makeLink mod="store" pg="index"}act=list{/makeLink}&sId={$smarty.request.sId}&fId={$smarty.request.fId}&mId={$MID}&limit={$smarty.request.limit}&pageNo={$smarty.request.pageNo}">List {$smarty.request.sId}</a></td> 
    </tr> 
    {if isset($MESSAGE)}
    <tr class=naGrid2>
...
<!--
	...
	{if $FIELDS.3==Y}
    <tr class="naGrid2"> 
      <td width=308 align="right" valign=top>{$smarty.request.sId} URL </td> 
      <td valign=top>:</td> 
  ...
  {/if}
	<tr class=naGrid1> 
      <td valign=top width=308><div align=right class="element_style">Home Page  Heading 1</div></td> 
      <td width=3 valign=top>:</td> 
	  <td><input name="heading1" type="text" class="input" id="heading1" value="{$STORE.heading1}" size="30" /></td>
	</tr>
	<tr class=naGrid2> 
      <td valign=top width=308><div align=right class="element_style">Home Page Heading 2</div></td> 
      <td width=3 valign=top>:</td> 
	  <td><input name="heading2" type="text" class="input" id="heading2" value="{$STORE.heading2}" size="30" /></td>
	</tr>
	{if !($smarty.request.id)}
	<tr class=naGrid2> 
      <td valign=top width=308><div align=right class="element_style">Registration Package</div></td> 
      <td width=3 valign=top>:</td> 

  ...
  <tr> 
    <td><table border=0 width=100% cellpadding="5" cellspacing="0"> 
        ...
        <tr>
          ...
          <td width="10%" nowrap class="naGridTitle">{makeLink mod=store pg=index orderBy="active" display="Status"}act=list&sId={$smarty.request.sId}&fId={$smarty.request.fId}{/makeLink}</td>
        </tr>

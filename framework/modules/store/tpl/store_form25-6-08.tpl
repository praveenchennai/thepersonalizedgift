...
<form action="" method="post" enctype="multipart/form-data" name="subFrm"  style="margin:0px; ">
...
<!--
   ...
   {if $FIELDS.8==Y}
	...
	{elseif file_exists("`$smarty.const.SITE_PATH`/modules/store/images/`$STORE.id`.jpg")}
    <tr class=naGrid2>
      <td valign=top align="right">&nbsp;</td>
      <td valign=top>&nbsp;</td>
      <td><img src="{$GLOBAL.mod_url}/images/{$STORE.id}.jpg" width="79" height="100"/></td>
    </tr>
	{/if}
	{/if}
	{if $FIELDS.17==Y}
    <tr class=naGrid2>
      <td valign=top align="right">{$smarty.request.sId} Heading1 </td>
      <td valign=top>:</td>
      <td><input type="text" name="heading1"  id="heading1" value="{$STORE.heading1}" class="formText" size="30" maxlength="27"/>
      </td>
    </tr>
	{/if}
	{if $FIELDS.18==Y}
    <tr class=naGrid2>
      <td valign=top align="right">{$smarty.request.sId} Heading2 </td>
      <td valign=top>:</td>
      <td><input type="text" name="heading2"  id="heading2" value="{$STORE.heading2}" class="formText" size="30" maxlength="44"/>
      </td>
    </tr>
	{/if}

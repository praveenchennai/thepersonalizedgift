...
<form action="" method="post" enctype="multipart/form-data" name="subFrm">
    ...
    <tr> 
	  ...
	  <td width="417" align="right"><a href="{$smarty.const.SITE_URL}/{$STORE.name}"></a><a href="{makeLink mod="store" pg="index"}act=list{/makeLink}&sId={$smarty.request.sId}&fId={$smarty.request.fId}&mId={$MID}">List {$smarty.request.sId}</a></td> 
    </tr> 
    {if isset($MESSAGE)}
    <tr class=naGrid2>

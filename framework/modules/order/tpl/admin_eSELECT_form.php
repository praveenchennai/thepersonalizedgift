...
<form action="" method="post" enctype="multipart/form-data" name="frm">
    ...
    <tr class=naGrid2>
      <td width="230"  align="right" valign=top>Merchant Store ID</td>
      <td valign=top>:</td>
      <td align="left"><input name="eSEL_store_id" type="text" class="input" id="eSEL_store_id" value="{$FORM_VALUES.eSEL_store_id}" size="30"/>        <font color="#999999" size="-3">&nbsp; </font></td>
      </tr>
    <tr class=naGrid2> 
      <td  align="right" valign=top>Merchant Token Key</td> 
      <td width=3 valign=top>:</td> 
      <td align="left"><input name="eSEL_api_token" type="text" class="input" id="eSEL_api_token" value="{$FORM_VALUES.eSEL_api_token}" size="30" /></td> 
    </tr>
	<tr class=naGrid2> 
      <td  align="right" valign=top>Development Server (Test)</td> 
      <td width=3 valign=top>:</td> 
      <td align="left"> <input type="checkbox" name="eSEL_mod" id="eSEL_mod" value="Y" {if $FORM_VALUES.eSEL_mod eq 'Y'}checked{/if}></td> 
    </tr>	  

...
<form action="" method="post" enctype="multipart/form-data" name="frm">
	...
	<input type="hidden" name="old_keyfile" value="{$FORM_VALUES.keyfile}">
    ...
    <tr class=naGrid2>
      <td width="230"  align="right" valign=top>Merchant Store Number </td>
      <td valign=top>:</td>
      <td colspan="2" align="left"><input name="configfile" type="text" class="input" id="coupon_name" value="{$FORM_VALUES.configfile}" size="30"/>        
      <font color="#999999" size="-3">&nbsp; </font></td>
      </tr>
    <tr class=naGrid2> 
      <td  align="right" valign=top>Key File </td> 
      <td width=3 valign=top>:</td> 
      <td width="218" align="left"><input name="keyfile" type="file" id="keyfile"></td>
      <td width="290" align="left">{if $FORM_VALUES.keyfile neq "" }<a href="{makeLink mod=$MOD pg=$PG}act=downloadcertificate&filename={$FORM_VALUES.keyfile}{/makeLink}"><img title="Download KeyFile" alt="Download KeyFile" src="{$GLOBAL.tpl_url}/images/grid/icon_download.gif" border="0"></a>{/if}</td>
    </tr>
   <tr class=naGrid2>

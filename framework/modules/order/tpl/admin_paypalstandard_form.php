...
<form action="" method="post" enctype="multipart/form-data" name="frm">
    ...
    <tr align="left">
      <td colspan=4 valign=top><table width="400%" align="center">
        <tr>
          ...
          <td width="77%" align="right" nowrap class="titleLink"><a href="{makeLink mod=order pg=payment}act=paymentlist{/makeLink}&store_id={$smarty.request.store_id}&sId={$smarty.request.sId}&fId={$smarty.request.fId}&mId={$MID}">{$smarty.request.sId} List</a></td>
        </tr>
      </table></td>
    </tr>
	{if isset($MESSAGE)}
    ...
    <tr class=naGrid2>
      <td width="230"  align="right" valign=top>Paypal URL </td>
      <td valign=top>:</td>
      <td width="180" align="left"><input name="paypal_url" type="text" class="input" id="coupon_name" value="{$FORM_VALUES.paypal_url}" size="30"/></td>
      <td width="328" align="left"><font color="#999999" size="-3"> https://www.paypal.com/cgi-bin/webscr</font> </td>
    </tr>
    <tr class=naGrid2> 
      <td  align="right" valign=top>PayPal Account of the seller</td> 
      <td width=3 valign=top>:</td> 
      <td colspan="2" align="left"><input name="business" type="text" class="input" id="coupon_start" value="{$FORM_VALUES.business}" size="30" /></td> 
    </tr>
   <tr class=naGrid2>
	 ...
	 <table width="100%" cellpadding="0" cellspacing="0">
			...
			<tr class="{cycle name=bg values="naGrid1,naGrid2"}">
			  ...
			  <td height="35" align="left" nowrap>{if $creditcard.logo_extension ne ''} <img src="{$GLOBAL.mod_url}/images/paymenttype/{$creditcard.id}{$creditcard.logo_extension}" width="50" height="30">{/if}</td>
			</tr> 
			{/foreach}
			{else}		
				<tr class="naGrid2"> 

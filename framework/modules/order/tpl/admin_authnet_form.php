...
<form action="" method="post" enctype="multipart/form-data" name="frm">
    ...
    <tr class=naGrid2> 
      ...
      <td align="left"><input name="auth_net_tran_key" type="text" class="input" id="coupon_start" value="{$FORM_VALUES.auth_net_tran_key}" size="30" /></td> 
	   ...
	   <tr class=naGrid2> 
      <td  align="right" valign=top>Automated Recurring Billing</td> 
      <td width=3 valign=top>:</td> 
      <td align="left"> <input type="checkbox" name="auth_net_arb" value="Y" {if $FORM_VALUES.auth_net_arb eq 'Y'}checked{/if}></td> 
    </tr>

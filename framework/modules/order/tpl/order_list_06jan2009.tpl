...
{if $LISTING_TYPE eq 'N'}
	<table border=0 width=100% cellpadding="5" cellspacing="0"> 
	  ...
	  <tr>
	    <td><a href="#" onClick="javascript:document.form2.action='{makeLink mod=$smarty.request.mod pg=$smarty.request.pg}act=list&date_from={$DATE_FROM}&date_to={$DATE_TO}{/makeLink}';document.form2.submit();">Archive</a></td>
		<td>&nbsp;</td>

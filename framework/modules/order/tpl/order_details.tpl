...
<table align="center" width="96%" border="0" cellspacing="0" cellpadding="0" class="naBrdr">
                      ...
                      <tr>
                        <td valign="top"  class="naFooter"><table width="100%" border="0" align="center" cellpadding="4" cellspacing="1">
                            ...
                            <tr class="naGrid2">
                              ...
                              <td><strong>{$row->name}&nbsp;{if $row->brand_id>0}({$row->brand_name}){/if}&nbsp;{if $row->cart_name}:&nbsp;({$row->cart_name}){/if}</strong></td>
  ...
  <tr>
    <td  class="naH1">IPN Status</td>
  </tr>
  <tr>
  	<td>&nbsp;</td>
  </tr>
  <tr>
    <td><div style="width:280px; height:150px; overflow:auto; border:1px solid">{$LOG_DET[0]->ipn_variables} </div></td>
  </tr>
</table>
</td></tr>

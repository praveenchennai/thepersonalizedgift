      ...
      <td valign="top">      
	   {if $HIDE_OPR eq 0}
        <table align="center" width="100%" border="0" cellspacing="0" cellpadding="0" class=naBrdr> 
         ...
         {/if}
        <br>
	    {if $smarty.request.section_id}
        <table align="center" width="100%" border="0" cellspacing="0" cellpadding="0" class=naBrdr> 
          <tr> 
            <td><table width="98%" align="center"> 
                <tr> 
                  <td width="80%" nowrap class="naH1">Content Pages<!-- Pages of {$MENU.name} --></td> 
                  <td width="20%" align="right" nowrap class="titleLink">
				  Section :
				  ...
				  <!-- {if $HIDE_OPR eq 0}<a href="{makeLink mod=$smarty.request.mod pg=$pageurl}act=form&menu_id={$smarty.request.id}{/makeLink}">Add New</a>{/if} --></td> 
                </tr> 
              </table></td> 
          </tr>
          <tr> 
            <td><table border=0 width=100% cellpadding="5" cellspacing="0"> 
                ...
                <tr>
                  ...
                  <td nowrap class="naGridTitle" align="left">Page Title</td>
                ...
                <tr class="{cycle name=a values="naGrid1,naGrid2"}"> 
                  ...
                  <td height="24" align="left" valign="middle"><a class="linkOneActive" href="{makeLink mod=$smarty.request.mod pg=$pageurl}act=form&id={$page->id}&menu_id={$page->menu_id}{/makeLink}">{$page->menu_name}</a></td> 
                  <td height="24" align="left" valign="middle">{$page->title}<!-- <a class="linkOneActive" href="{makeLink mod=$smarty.request.mod pg=$pageurl}act=form&id={$page->id}&menu_id={$page->menu_id}{/makeLink}">{$page->title}</a> --></td>
                  <td valign="middle" height="24" align="center"><!-- {$page->position} --></td> 
                </tr> 
                {/foreach}
                <tr> 
                  <td colspan="5" class="msg" align="center" height="30">{$PAGE_NUMPAD}</td> 
                </tr>
                {else}
                 <tr class="naGrid2"> 

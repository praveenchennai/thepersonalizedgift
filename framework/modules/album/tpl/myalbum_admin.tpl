...
<table width="95%"  cellspacing="0" cellpadding="0">
                <tr valign="middle">
                  <td width="79%" height="39" class="naH1">Media List </td>
                      ...
                      <tr>
                        ...
                        <td align="right" valign="top"><span class="smalltext">
                            ...
                            <tr>
                              ...
                              <td width="29%" colspan="3"  class="naGridTitle">{$MEDIA}s</td>
							...
							<tr bgcolor="#F6F5F5">
                              <td colspan="5" bgcolor="#F6F5F5" class="blacktext"><table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                  <td height="1" align="center"><span class="smalltext"><span class="smalltext" style="color:#FF0000"><strong>No {$MEDIA}s Found in {$ALB_NM}</strong></span></span></td>
                                </tr>
                                <tr>
							...
							{/if}
                            {foreach from=$PHOTO_LIST item=photo}
                            <tr bgcolor="#F6F5F5">
                              <td colspan="5" bgcolor="#F6F5F5" class="blacktext"><table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td>&nbsp;</td>
                            ...
                            <tr bgcolor="#DEDEDE">
                              <td height="20" colspan="5" >&nbsp;<span class="smalltext">{$PHOTO_NUMPAD}</span></td>
                            </tr>
                          </table></td>
                      </tr>
                    </table>

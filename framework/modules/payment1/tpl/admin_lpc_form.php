...
<form action="" method="post" enctype="multipart/form-data" name="frm">
    ...
    <tr class=naGrid2>
      <td  align="right" valign=top>Merchant Store Number </td>
      <td valign=top>:</td>
    ...
    <tr class=naGrid2> 
      ...
      <td width="290" align="left">{if $FORM_VALUES.keyfile neq "" }<a href="{makeLink mod=payment pg=index}act=downloadcertificate&filename={$FORM_VALUES.keyfile}{/makeLink}"><img title="Download KeyFile" alt="Download KeyFile" src="{$GLOBAL.tpl_url}/images/grid/icon_download.gif" border="0"></a>{/if}</td>
    </tr>
   <tr class=naGrid2>

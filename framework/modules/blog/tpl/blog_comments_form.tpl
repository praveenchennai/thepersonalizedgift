          ...
          <td width="95%" height="169" align="left" valign="top" bgcolor="#EEEEEE">
              ...
              <tr>
				...
				<tr>
				  <td colspan="2" align="right" valign=middle >&nbsp;</td>
				  <td valign="middle">
					<input name="post_title" type="text" class="input" id="post_title"  size="30" maxlength="25" value="{$BLOG_ENTRY_DETAILS.post_title}">
				...
				<tr>
				  ...
				  <td valign="middle">
                    <table width="570" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><textarea name="post_description" cols="40" rows="5" class="input" id="post_description">{$BLOG_ENTRY_DETAILS.post_description}</textarea>
                          <input type="hidden" name="id" value="{$BLOG_ENTRY_DETAILS.id}">
                          <input name="blog_id" type="hidden" id="blog_id" value="{$BLOG_DETAILS.id}">						</td>
                      </tr>
                    </table>
				  </td>
				</tr>

  ...
  // print_r($req);
   //exit;  
    if(!trim($body_html)) {
      ...
      $array = array("cat_id"=>$cat_id,"body"=>$body_html,"topic_id"=>$id,"user_id"=>$user_id,"posted_date"=>$datevar);
...
/**
	 ...
	 * @return Boolean/Error Message	 
	 */
  function topicAddEdit (&$req,$file,$tmpname,$cat_id="",$getID="") {
	...
	
	{
		...
		if($file){	
			...
			$array = array("topic_name"=>$topic_name,"topic_desc"=>$description,"image"=>$file,"active"=>$active);
			 ...
			 $array = array("topic_name"=>$topic_name,"cat_id"=>$cat_id,"user_id"=>$getID,"topic_desc"=>$body_html,"active"=>'y',"posted_on"=>$datevar);
			  ...
			  if($id) {
				...
				$this->db->update("forum_topic", $array, "id='$id'");
				  ...
				  {   
				   $datevar=date("Y-m-d H:i:s");
				   $array = array("topic_name"=>$topic_name,"cat_id"=>$cat_id,"user_id"=>$getID,"topic_desc"=>$req['body_html'],"image"=>$file,"active"=>'y',"posted_on"=>$datevar);
				 }

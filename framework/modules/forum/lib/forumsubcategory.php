...
switch($_REQUEST['act']) {
    case "list":	
        list($rs, $numpad) = $forum->subCategoryList($_REQUEST['pageNo'], 10, "mod=$mod&pg=$pg&act=".$_REQUEST['act'], OBJECT, $_REQUEST['orderBy']);
        ...
        $framework->tpl->assign("main_tpl", SITE_PATH."/modules/forum/tpl/subcategory_list.tpl");
        break;
    case "form":

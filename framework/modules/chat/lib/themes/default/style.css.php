...
/*  background-repeat: repeat-xy;*/
  ...
  font-size:13px;
   font-color:#000000;
  /* without this rule, the tabs are not correctly display on FF */
}
...
div#pfc_channels_content {
  ...
  position: relative;
  width: 100%;
  <!--chat window  height  it can be changed to diffrent percentages--by jinson-->
...
span.pfc_nick {
  color: #fbac17;
  font-weight:normal;
  <!--nickname display bfr send text-->
}
...
p#pfc_handle {
  ...
  font-size: 90%;          /* these two line fix a display problem in IE6 : */
  vertical-align: top;
  white-space: pre;
}
...
div#pfc_errors {
  margin: 0 0 4px 0; padding-top: 15px;
  display: none;

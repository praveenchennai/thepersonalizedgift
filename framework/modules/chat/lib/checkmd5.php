...
if (md5(file_get_contents("./i18n/sv_SE/admin.php")) == "70ca8fc56a24db870586d387fd4969e9")
  $files_ok[] = "<span style=\"color:#3A3\">ok - ./i18n/sv_SE/admin.php</span>\n";
else
  $files_ko[] = "<span style=\"color:#F33\">corrupted - ./i18n/sv_SE/admin.php (please replace this file by a correct one)</span>\n";
...
if (md5(file_get_contents("./i18n/uk_RO/admin.php")) == "83f88499b55278c545997be4cdac0984")
  $files_ok[] = "<span style=\"color:#3A3\">ok - ./i18n/uk_RO/admin.php</span>\n";
else
  $files_ko[] = "<span style=\"color:#F33\">corrupted - ./i18n/uk_RO/admin.php (please replace this file by a correct one)</span>\n";
...
if (md5(file_get_contents("./i18n/ru_RU/admin.php")) == "68507654da5e323194dfef2283dfb9cc")
  $files_ok[] = "<span style=\"color:#3A3\">ok - ./i18n/ru_RU/admin.php</span>\n";
else
  $files_ko[] = "<span style=\"color:#F33\">corrupted - ./i18n/ru_RU/admin.php (please replace this file by a correct one)</span>\n";
...
if (md5(file_get_contents("./i18n/fr_FR/main.php")) == "29d68f0aaaa3bc9c3797f37adefce2fc")
...
if (md5(file_get_contents("./i18n/es_ES/main.php")) == "e0019a186e603e1f33ce844e355b680d")
...
if (md5(file_get_contents("./i18n/bg_BG/main.php")) == "c7a1cbca989f7fff36f4758c39eff63d")
...
if (md5(file_get_contents("./i18n/da_DK/admin.php")) == "4f301ba90c98ee80d2185729f739ceb6")
  $files_ok[] = "<span style=\"color:#3A3\">ok - ./i18n/da_DK/admin.php</span>\n";
else
  $files_ko[] = "<span style=\"color:#F33\">corrupted - ./i18n/da_DK/admin.php (please replace this file by a correct one)</span>\n";
...
if (md5(file_get_contents("./i18n/pl_PL/admin.php")) == "c94db6655469dd17f785bdf9c147a4ac")
  $files_ok[] = "<span style=\"color:#3A3\">ok - ./i18n/pl_PL/admin.php</span>\n";
else
  $files_ko[] = "<span style=\"color:#F33\">corrupted - ./i18n/pl_PL/admin.php (please replace this file by a correct one)</span>\n";
if (md5(file_get_contents("./i18n/pl_PL/main.php")) == "8af8b794aee6ea332b6d7732afd5477b")
...
if (md5(file_get_contents("./i18n/pt_BR/main.php")) == "68f4fe9d76584526e9b5c2bc28f1153c")
...
if (md5(file_get_contents("./i18n/ja_JP/admin.php")) == "099449cc2a535e556b70cbae7c8682c6")
  $files_ok[] = "<span style=\"color:#3A3\">ok - ./i18n/ja_JP/admin.php</span>\n";
else
  $files_ko[] = "<span style=\"color:#F33\">corrupted - ./i18n/ja_JP/admin.php (please replace this file by a correct one)</span>\n";
...
if (md5(file_get_contents("./i18n/hu_HU/admin.php")) == "0b0ff908e9f97e21d2dd573094f079cc")
  $files_ok[] = "<span style=\"color:#3A3\">ok - ./i18n/hu_HU/admin.php</span>\n";
else
  $files_ko[] = "<span style=\"color:#F33\">corrupted - ./i18n/hu_HU/admin.php (please replace this file by a correct one)</span>\n";
if (md5(file_get_contents("./i18n/hu_HU/main.php")) == "53a5ddfb621cd145d1d0bd2ada15d59c")
...
if (md5(file_get_contents("./i18n/it_IT/admin.php")) == "700843403b211be81e19fc954c78534b")
  $files_ok[] = "<span style=\"color:#3A3\">ok - ./i18n/it_IT/admin.php</span>\n";
else
  $files_ko[] = "<span style=\"color:#F33\">corrupted - ./i18n/it_IT/admin.php (please replace this file by a correct one)</span>\n";
...
if (md5(file_get_contents("./i18n/de_DE-formal/main.php")) == "9cbffe3f309a632c87e84a8069804e61")
...
if (md5(file_get_contents("./demo/demo44_green_theme.php")) == "b87d6b07440793e88fd38b948cbb495d")
...
if (md5(file_get_contents("./demo/demo50_customized_usermetadata.php")) == "0e57f8a93dcccc62e2b5cbc116c41b9c")
...
if (md5(file_get_contents("./demo/demo27_customized_command.php")) == "4d01fb0d334e965c9b5c82341afaf650")
...
if (md5(file_get_contents("./demo/demo61_in_croatian.php")) == "ebde6ded4223f0e21f66489b5dc6117f")
...
if (md5(file_get_contents("./demo/demo54_in_esperanto.php")) == "8c4a80a5b72e122530f2569bf7443adf")
...
if (md5(file_get_contents("./demo/demo47_in_polish.php")) == "1df60393a0ce4e2c210d58bced36eec3")
...
if (md5(file_get_contents("./demo/demo34_add_a_link_on_nicknames.php")) == "5f8a23a8e3ce1213001cf44620cc8318")
...
if (md5(file_get_contents("./demo/demo55_mysql_container.php")) == "84f6dfab0bfb9862014fc1c92701bf8d")
...
if (md5(file_get_contents("./demo/demo8_with_a_iso-8859-1_encoded_page.php")) == "0afeabd0c5d89f198cc95843d99d5071")
...
if (md5(file_get_contents("./demo/demo52_in_bangla.php")) == "76bbf8bd91859a8764db83c375f50154")
...
if (md5(file_get_contents("./demo/demo48_custom_proxy.php")) == "85c1197b99502262749c0599bcdc2741")
...
if (md5(file_get_contents("./demo/demo53_in_armenian.php")) == "3984bcc2260a6f2395ed876cf918f631")
...
if (md5(file_get_contents("./demo/demo15_multiple_channel.php")) == "355b68e5413bae2073a06a46740c4f37")
...
if (md5(file_get_contents("./demo/index.php")) == "954d32ac028037c0fac3ca463391f889")
...
if (md5(file_get_contents("./demo/demo43_change_the_nicknames_colors.php")) == "db62a0172cd7d810d708abd065a733d2")
...
if (md5(file_get_contents("./demo/demo51_zilveer_theme.php")) == "a20f9ce729078121b1564678373b1a24")
...
if (md5(file_get_contents("./demo/demo28_mini_blune_theme.php")) == "24d877636f9335bd1422acdad717541c")
...
if (md5(file_get_contents("./demo/demo59_in_norwegian_nynorsk.php")) == "2a18f2180cb80a14370c750d30556e7c")
...
if (md5(file_get_contents("./demo/demo57_in_korean.php")) == "183f5f4e1e743f963bd4980a85745ae9")
...
if (md5(file_get_contents("./demo/demo5_customized_style.php")) == "9a41a4c86227fd6ef378cd1486064aac")
...
if (md5(file_get_contents("./demo/demo31_show_who_is_online-whoisonline.php")) == "d0b9410a3cbcc275eacd7aa3cb9929d0")
...
if (md5(file_get_contents("./demo/demo56_in_romanian.php")) == "b6076d4c1158a3d434ed6dd8e5c58862")
...
if (md5(file_get_contents("./demo/demo58_in_danish.php")) == "1b6b72eb40f4a03187c2510e33899a5e")
...
if (md5(file_get_contents("./demo/demo21_with_hardcoded_urls.php")) == "e2ea1112e76ee0dd8be31244190b56bd")
...
if (md5(file_get_contents("./demo/demo60_in_vietnamese.php")) == "b475d568f41b632ded8d52d1774ea442")
...
if (md5(file_get_contents("./demo/demo28_blune_theme.php")) == "4088816b433d16e7d58928445c9019d1")
...
if (md5(file_get_contents("./demo/demo2_simple_with_params.php")) == "1acb5f037ac8e6284297e72d08c9f3cc")
...
if (md5(file_get_contents("./demo/demo49_msn_smiley_theme.php")) == "7c96f74832e27e2eccb2b66d1bebaff9")
...
if (md5(file_get_contents("./demo/demo31_show_who_is_online-chat.php")) == "56baacb4beb971e13211064e2d3fa7fc")
...
if (md5(file_get_contents("./demo/demo36_in_ukrainian.php")) == "eae4b684f004b96713d94aa9a8dcb525")
...
if (md5(file_get_contents("./themes/default/chat.html.tpl.php")) == "e8c53724492c4e40209c1adf228d41c7")
...
if (md5(file_get_contents("./themes/default/chat.js.tpl.php")) == "1cff1e32671b1dece6dc9004c724e39b")
...
if (md5(file_get_contents("./themes/blune/style.css.php")) == "c7f62b1d3928be93259a863393d29941")
...
if (md5(file_get_contents("./src/commands/connect.class.php")) == "0f9a67d2603c649610962ecb88dda681")
...
if (md5(file_get_contents("./src/commands/getnewmsg.class.php")) == "9a51f4f4b49db292d63cb66af83b1ed8")
...
if (md5(file_get_contents("./src/commands/send.class.php")) == "0cbe9371e804101881a6b224fd0a965f")
...
if (md5(file_get_contents("./src/commands/who.class.php")) == "9688afabf35cb61bad533eb1cf59d384")
...
if (md5(file_get_contents("./src/containers/mysql.class.php")) == "32ecffff0d110a650e170cf854375ac2")
...
if (md5(file_get_contents("./src/containers/file.class.php")) == "72cb5607a8e26da0f83eb9391533c0ce")
...
if (md5(file_get_contents("./src/phpfreechat.class.php")) == "70deeb3be6caacc6f0da4fd9b3f856b5")
...
if (md5(file_get_contents("./src/pfccontainer.class.php")) == "4d7e315d377f163c213ae4ac884c99da")
...
if (md5(file_get_contents("./src/pfci18n.class.php")) == "ac363e16f72edb3b9b8935a682a08a8b")
...
if (md5(file_get_contents("./src/pfcglobalconfig.class.php")) == "6e18cb167148663c610438e53c0f9c25")
...
if (md5(file_get_contents("./misc/generate-doc.inc.php")) == "a68566e7281acdbe8418b692480d5bb0")
...
if (md5(file_get_contents("./data/public/js/prototype.js")) == "3766aeff5778b54f74f93670322ca0df")
...
if (md5(file_get_contents("./data/public/js/pfcclient.js")) == "bc289739f813b61bd3006479200850c6")
...
if (md5(file_get_contents("./data/public/js/pfcgui.js")) == "7e2c964ff1867969da248ad80a5e5692")
...
if (md5(file_get_contents("./data/public/js/pfcresource.js")) == "9ebb5e7325cd2ec4d3d8a02dc342c862")
...
if (md5(file_get_contents("./data/public/js/md5.js")) == "ee3a962f93b0031161f08e7c6503f961")
...
if (md5(file_get_contents("./version.txt")) == "9badb63c1021d9276f4130485e868c4c")
...
if (md5(file_get_contents("./testcase/container_generic.php")) == "05686e57366e3a06e7972692bb5f4b89")

    ...
    <tr align="left">
      <td colspan=4 valign=top><table width="100%" align="center">
        <tr>
          ...
          <td width="77%" align="right" nowrap class="titleLink"><a href="{makeLink mod=extras pg=extras}act=list{/makeLink}&sId={$SUBNAME}&mId={$MID}">{$SUBNAME} List</a></td>
        </tr>
      </table></td>
    </tr>
	{if isset($MESSAGE)}
	...
	{/if}	
	 <table width="100%"  border="0" cellpadding="0" cellspacing="0">
       <tr>
         ...
         <td width="75%"><input type="text" name="coupon_amount" class="input" size="10" value="{$COUPON.coupon_amount}"></td>
       </tr>
     </table>
	 </div> 
	 </td>

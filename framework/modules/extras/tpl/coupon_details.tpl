 	...
 	<tr align="left">
      <td colspan=4 valign=top><table width="100%" align="center">
        <tr>
          ...
          <td width="83%" align="right" nowrap class="titleLink"><a href="{makeLink mod=extras pg=extras}act=list{/makeLink}&sId={$smarty.request.sId}">CouponList</a> </td>
        </tr>
      </table></td>
    </tr>
	{if isset($MESSAGE)}
...
{if $COUPON_DETAILS.Subscriptions|@count > 0}
   <tr class="naGridTitle" height="25" nowrap="nowrap">
     <td colspan="4" align="left" valign=bottom>Subscriptions Available under this Coupon</td>
...
{if $COUPON_DETAILS.Packages|@count > 0}
   <tr class="naGridTitle" height="25" nowrap="nowrap">
     <td colspan="4" align="left" valign=bottom>Packages Available under this Coupon</td>

  ...
  <tr> 
    <td><table border=0 width=100% cellpadding="5" cellspacing="0"> 
        ...
        <tr>
          ...
          <td width="5%" nowrap class="naGridTitle" height="24" align="center"></td> 
          <td width="70%" nowrap class="naGridTitle" height="24" align="left">{makeLink mod=$MOD pg=$PG orderBy="name" display="Name"}act=list{/makeLink}</td> 
        ...
        <tr class="{cycle values="naGrid1,naGrid2"}"> 
          <td valign="middle" height="24" align="center"><a class="linkOneActive" href="{makeLink mod=$MOD pg=$PG}act=form&id={$row->id}{/makeLink}"><img title="Edit" alt="Edit" src="{$GLOBAL.tpl_url}/images/grid/icon.edit.gif" border="0"></a></td> 
          ...
          <td valign="middle" height="24" align="left"><a class="linkOneActive" href="{makeLink mod=$MOD pg=$PG}act=form&id={$row->id}{/makeLink}">{$row->name}</a></td> 

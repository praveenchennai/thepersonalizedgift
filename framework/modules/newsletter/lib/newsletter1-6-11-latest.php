...
error_reporting(E_ALL ^ E_NOTICE);
	...
	case "view_newsletter_emails":
		$emails = $newsletter->newsletterEmails($_REQUEST['country'],$_REQUEST['active'],$_REQUEST['confirmed'],$_REQUEST['reg_pack'],$_REQUEST['sub_pack'],$_REQUEST['date_from'],$_REQUEST['date_to'],$_REQUEST['email']);

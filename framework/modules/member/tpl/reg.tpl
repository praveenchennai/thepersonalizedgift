<SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript" src="{$smarty.const.SITE_URL}/includes/datepicker/calendar.js">
</script>
...
*/
		...
		function validEmail(email) {
			...
			document.getElementById("email_div").innerHTML =
				"<img src='{$GLOBAL.tpl_url}/images/blue_light.gif' border='0' height='23'/><strong style='color:#990000'>CHECKING...</strong>";
			var req1 = newXMLHttpRequest();
...
{if ($smarty.request.id=="")}
	...
	{literal}
		<SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
			...
			var fields = new Array('mem_type', 'first_name', 'last_name', 'email', 'username', 'password', 'confirm_pass',
				'address1', 'country', 'postalcode');
			var msgs = new Array('Member Type', 'First Name', 'Last Name', 'Email', 'Username', 'Password', 'Confirm Password',
...
<table border=0 width=80% cellpadding=5 cellspacing=1 class=naBrDr>
	<form action="" method="post" enctype="multipart/form-data" name="frmReg" id="frmReg"
		onSubmit="return submit_form()">
		<tr>
			<td nowrap class="naH1" colspan="2">User Registration</td>
			<td align="right">&nbsp;
				<!-- <a href="{makeLink mod="$MOD" pg="$PG"}act=list{/makeLink}">List Mailing Lists</a> -->
			</td>
		</tr>
		{if isset($MESSAGE)}
			<tr class=naGrid2>
		...
		<tr class=naGrid2>
			...
			<td width=1% valign=top>:*</td>
			<td width="59%"><input name="first_name" type="text" class="input" id="first_name" value="" size="30" />
			</td>
		</tr>
		<tr class=naGrid2>
		...
		<tr class=naGrid2>
			...
			<td width=1% valign=top>:*</td>
			<td width="59%"><input name="email" type="text" class="input" id="email" value="" size="30"
					{if ($smarty.request.id!="")} {else} onBlur="validEmail(this.value)" {/if} />
		...
		{if ($smarty.request.id=="")}
			<tr class=naGrid2>
				...
				<td width=1% valign=top>:*</td>
				<td width="59%">
					<input name="username" type="text" class="input" id="username" value="" size="30"
						onBlur="validUname(this.value)" />
		...
		<tr class=naGrid2>
			...
			<td width=1% valign=top>:*</td>
			<td width="59%"><textarea name="address1" rows="5" class="input" id="address1"
		...
		<tr class=naGrid2>
			...
			<td width=1% valign=top>:*</td>
			<td width="59%">
				<select name="country" class="input" id="country" style="width:180px "
		...
		<tr class=naGrid2>
			...
			{else}
				<td width="59%">
					<div id="div_state" class="bodytext"><input name="state" type="text" class="input" id="state"
							value="{$smarty.request.state}" size="30" /></div>
				</td>
			{/if}
		</tr>
		{if $smarty.request.state}
			<SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
				show_state('state', {$smarty.request.country}, '{$smarty.request.state}');
			</SCRIPT>
		{/if}
		<tr class=naGrid2>
			<td width=40% align="right" valign=top>Zipcode</td>
			<td width=1% valign=top>:*</td>
			<td width="59%"><input name="postalcode" type="text" class="input" id="postalcode" value="" size="30" />
			</td>
		</tr>
		<tr class=naGrid2>
		...
		<tr class="naGridTitle">
			<td colspan=3 valign=center>
				<div align=center>
					<input name="btn_save" type="submit" id="btn_save" value="Register" class="button_class"
						style="width:75">&nbsp;
					<input type="button" name="Button" value="Cancel" class="button_class"
						onClick="javascript: history.go(-1)" style="width:75">
				</div>
			</td>
		</tr>
	</form>

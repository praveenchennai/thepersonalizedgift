...
<div style="width:96%">
	...
	<div style="width:99%">
		...
		<div style="width:650px;float:left;text-align:justify;">
			<div class="floatleft"><span class="meroon">Accomodation : </span><span class="bodytext">{$FLYER_BASIC.title}</span></div>
			<div class="floatright"></div>
			<div class="sepertor5px"></div>
			<div class="sepertor5px"></div>
			<div class="floatleft"><span class="bodytext" style="text-align:justify;">{$FLYER_BASIC.description}</span></div>
		</div>
		<div class="divSpc"></div>
	</div>
		<div class="sepertor10px"><!-- --></div>
	...
	<!-- PHOTO LISTING START HERE -->
	 <div style="width:100%;">
		...
		<div class="sepertor10px"><!-- --></div>
			{if $DEFAULT_IMG > 0}
			<div class="floatleft" style="width:480px;height:310px;">
			...
			<div class="floatright" style="width:390px;">
				{foreach from=$PHOTO_LIST item=rowPh name =foo key=id}
					...
					<div class="floatleft" style="width:130px;"><img  src="{$smarty.const.SITE_URL}/modules/album/photos/thumb/{$rowPh.id}_thumb2{$rowPh.img_extension}" onClick="return popertyPhotoLoad('{$id}')" style="cursor:pointer;"></div>
				{/foreach}
			</div>
			{/if}
		<div class="divSpc"></div>
	...
	<div style="width:100%">
		...
		<div class="floatleftwidth400normal">
			<div>&nbsp;</div>
			<div class="floatleftwidth120"><span class="meroon">Street Address :</span></div>
			<div class="floatleft">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
			<div class="floatleft"><span class="bodytext">{$FLYER_BASIC.location_street_address}</span></div>
			<div class="sepertor5px"><!-- --></div>

			
			<div class="floatleftwidth120"><span class="meroon">City :</span></div>
			<div class="floatleft">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
			<div class="floatleft"><span class="bodytext">{$FLYER_BASIC.location_city}</span></div>
			<div class="sepertor5px"><!-- --></div>
			
			<div class="floatleftwidth120"><span class="meroon">State :</span></div>
			<div class="floatleft">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
			<div class="floatleft"><span class="bodytext">{$FLYER_BASIC.location_state}</span></div>
			<div class="sepertor5px"></div>
			
			<div class="floatleftwidth120"><span class="meroon">Country :</span></div>
			<div class="floatleft">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
			<div class="floatleft"><span class="bodytext">{$FLYER_BASIC.location_state}</span></div>
			<div class="sepertor5px"><!-- --></div>
			
			<div class="floatleftwidth120"><span class="meroon">Zip :</span></div>
			<div class="floatleft">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
			<div class="floatleft"><span class="bodytext">{$FLYER_BASIC.location_zip}</span></div>
			<div class="sepertor5px"><!-- --></div>
			
			<div class="floatleftwidth120"><span class="meroon">Neighborhood :</span></div>
			<div class="floatleft">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
			<div class="floatleft"><span class="bodytext">{$FLYER_BASIC.location_neighborhood}</span></div>
			<div class="sepertor5px"><!-- --></div>
			
			<div class="floatleftwidth120"><span class="meroon">Show Map :</span></div>
			<div class="floatleft">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
			<div class="floatleft"><span class="bodytext">{if $FLYER_BASIC.show_map == 'Y'}Yes{else}No{/if}</span></div>
			<div class="sepertor5px"><!-- --></div>
			
			<div>&nbsp;</div>
			<div class="floatleftwidth120"><span class="meroon">Show Address :</span></div>
			<div class="floatleft">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
			<div class="floatleft"><span class="bodytext">{if $FLYER_BASIC.show_address == 'Y'}Yes{else}No{/if}</span></div>

		</div>
		
		<div class="floatrightwidth400normal">
			<div>&nbsp;</div>
			<div class="floatleftwidth120"><span class="meroon">Name :</span></div>
			<div class="floatleft">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
			<div class="floatleft"><span class="bodytext">{$FLYER_BASIC.contact_name}</span></div>
			<div class="sepertor5px"><!-- --></div>
			
			
			<div class="floatleftwidth120"><span class="meroon">Phone:</span></div>
			<div class="floatleft">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
			<div class="floatleft"><span class="bodytext">{$FLYER_BASIC.contact_phone}</span></div>
			<div class="sepertor5px"><!-- --></div>
			
			<div class="floatleftwidth120"><span class="meroon">Email :</span></div>
			<div class="floatleft">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
			<div class="floatleft"><span class="bodytext">{$FLYER_BASIC.contact_email}</span></div>
			<div class="sepertor5px"><!-- --></div>
			
			<div class="floatleftwidth120"><span class="meroon">Replay From :</span></div>
			<div class="floatleft">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
			<div class="floatleft"><span class="bodytext">{if $FLYER_BASIC.show_reply == 'Y'}Yes{else}No{/if}</span></div>
			<div class="sepertor5px"><!-- --></div>
			
			<div class="floatleftwidth120"><span class="meroon">Email On :</span></div>
			<div class="floatleft">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
			<div class="floatleft"><span class="bodytext">{if $FLYER_BASIC.show_email == 'Y'}Yes{else}No{/if}</span></div>
			<div class="sepertor5px"><!-- --></div>
...
{foreach key=key from=$FLYER_FEATURES.blocks item=block}
	<div style="width:100%">
			...
			<div class="floatleftwidth400normal">
				...
				<div class="divSpc"></div>
				<div align="left"><span class="meroon">{$label}&nbsp;&nbsp;:&nbsp;</span><span class="bodytext">{$value}</span></div>
					{/if}
				{/foreach}

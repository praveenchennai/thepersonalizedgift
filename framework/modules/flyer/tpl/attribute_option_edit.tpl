...
<table border=0 width=80% cellpadding=5 cellspacing=0 class=naBrDr> 
	...
	<tr valign="middle" class=naGrid1> 
      ...
      <td  width="57%" height="50"><input type="text" name="name" value="{$ITEM_VALUE.item_name}" class="formText" size="33" maxlength="50" > </td> 
    </tr>
		
	<tr class="naGridTitle"> 
      <td colspan=3 valign=center height="20"><div align=center> 
	  <input type="hidden" name="attribute_id" value="{$ITEM_VALUE.attr_group_id}">
	    <input type="hidden" name="item_id" value="{$ITEM_VALUE.item_id}">

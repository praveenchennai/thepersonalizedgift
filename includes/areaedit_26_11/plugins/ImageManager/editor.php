...
// if editing disabled prevent this from loading
...
// This page is opened by a call to Dialog() in ImageManager/images.php in the 
// editImage() js function. (That Dialog() call is defined in ImageManager/assets/dialog.js
//
...
_imgManager.ddt._ddt( "editor.php", "38", "top of editor.php file." );

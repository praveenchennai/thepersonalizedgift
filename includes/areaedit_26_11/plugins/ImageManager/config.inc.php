...
//
// 2005-06-01 YmL:
//	.	updated for AreaEdit.
//
// 2005-08-18 YmL:
//	.	added allow_edit and allow_delete options. Editing is on by default, deleting
//		is off.
//
// -------------------------------------------------------------------------
...
*
* probably already included. We assume we are in the areaedit/plugins/ImageManager
* directory
*/

if ( ! defined( "AREAEDIT_INSTALL_ROOT" ) )
	{
...
if ( @$IMConfig['backend_url' ] == NULL )
	{
	$IMConfig['backend_url'] = AREAEDIT_INSTALL_URL . "/backends/backend.php?__plugin=ImageManager&";
	}
...
if ( @$IMConfig[ 'base_dir' ] == NULL )
	{
	$IMConfig['base_dir'] = AREAEDIT_INSTALL_ROOT . "/plugins/ImageManager/";
	$IMConfig['base_url'] = AREAEDIT_INSTALL_URL . "/plugins/ImageManager/";
	}
...
if ( @$IMConfig['images_dir'] == NULL )
	{
	$IMConfig['images_dir'] = AREAEDIT_INSTALL_ROOT . "/examples/images";
	}
...
if ( @$IMConfig['images_url'] == NULL )
	{
	$IMConfig['images_url'] = AREAEDIT_INSTALL_URL . "/examples/images";
	}
...
* FALSE - No editing.
*
* DEFAULT: for demo purposes we turn this on.
*/

if ( @$IMConfig[ 'allow_edit' ] === NULL )
	{
...
* Possible values: true, false
*
* TRUE -  Allow the user to delete images.
*
* FALSE - No deleting.
*/

if ( @$IMConfig[ 'allow_delete' ] === NULL )
	{
...
if ( !function_exists( "_ddt" ) )
	{
	include_once( AREAEDIT_INSTALL_ROOT . "/ddt/ddt.php" );
	}

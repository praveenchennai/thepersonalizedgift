...
var _imgManager = window.opener.Dialog._editor.plugins[ "ImageManager" ].instance;
...
// we have to propagate these values through forms. NOTE that to support
// all possible backend_urls we'll need to pass through any get variables as well.

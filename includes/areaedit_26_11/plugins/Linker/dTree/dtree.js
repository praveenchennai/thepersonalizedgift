/**
* @fileoverview dTree 2.05 | www.destroydrop.com/javascript/tree/ 
*
...
* Updated: 17.04.2003                               
*
* Modification by Yermo Lamers http://www.formvista.com/contact.html
*
* . added clear_s() to clear selection.
...
*
* @todo the name of this method is confusing.
*/
...
dTree.prototype.getNodeElement = function( n )
	{
	return document.getElementById("s" + this.obj + n);
	}

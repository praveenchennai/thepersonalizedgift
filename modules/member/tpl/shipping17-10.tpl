...
<div style="width:700px; padding: 5px; margin: 0px auto;">
	<div class="greyboldext">Billing Details</div>
    <div><hr size="1"  class="border1"/><strong>( * Mandatory Fields )</strong></div>
	...
	<div class="bodytext">
		<span>Country: *</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<span>
			<select name="country" class="input" id="country" style="width:195px " onChange="javascript: show_state('new_state',this.value,'');">

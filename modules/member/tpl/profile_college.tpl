<form name="frcollege" method="post" action="">
        ...
        <td width="90%"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td height="244" colspan="2" align="center" valign="top" class="blacktext">
              <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td colspan="3"><span class="smalltext"><strong class="greyboldtext style1">College</strong></span></td>
                </tr>
                <tr>
                        ...
                        <td width="578" align="left" valign="top" bgcolor="#EEEEEE"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                              <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  ...
                                  <tr>
                                    <td width="123" height="30" align="left" valign="middle"><span class="blackboldtext">College1:</span></td>
                                    <td width="15" height="30" align="left"><span class="smalltext"> </span></td>
                                    <td height="30" colspan="2">
                                      <p><span class="smalltext">
                                        <input name="college1" type="text" id="college1" value="{$PRF_COLLEGE.college1}" size="26">
                                    </span><span class="smalltext"> </span></p></td>
                                  </tr>
                                  <tr>
                                    <td height="30" align="left" valign="middle"><span class="blackboldtext">College2:</span></td>
                                    <td height="30" align="left">&nbsp;</td>
                                    <td width="162" height="30"><span class="smalltext">
                                      <input name="college2" type="text" id="college2" value="{$PRF_COLLEGE.college2}" size="26">
                                    </span></td>
                                    <td width="220">&nbsp;</td>
                                  </tr>

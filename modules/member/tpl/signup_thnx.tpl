				  ...
				  <tr align="left">
				   ...
				   <tr>
					...
					<!--  <tr>
					   ...
					   <tr>
                        <td width="21%">{$MOD_VARIABLES.MOD_LABELS.LBL_ITEM_NAME}</td>
                        <td width="2%">&nbsp;</td>
                        <td width="77%">{$ITEM_NAME}</td>
                      </tr>
					  <tr>
                        <td>{$MOD_VARIABLES.MOD_LABELS.LBL_AMOUNT_PAID}</td>
                        <td>&nbsp;</td>
                        <td>${$AMOUNT}</td>
                      </tr>
					  <tr>
                        <td width="21%">{$MOD_VARIABLES.MOD_LABELS.LBL_PAYER_EMAIL}</td>
                        <td width="2%">&nbsp;</td>

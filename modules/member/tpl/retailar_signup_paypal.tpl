	...
	<input type="hidden" name="return" id="return_url" value="{makeLink mod='member' pg='signup' urlcomplete=1 }act=payment_completed{/makeLink}">
	
	<input type="hidden" name="cancel_return" value="{makeLink mod='member' pg='signup' urlcomplete=1 }act=retailar_reg&retailer=1{/makeLink}">
	
	<input type="hidden" name="notify_url" value="{makeLink mod='member' pg='signup' urlcomplete=1 }act=validate_payment{/makeLink}">

<SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript" src="{$smarty.const.SSL_SITE_URL}/scripts/validator.js"></script>
<script language="javascript" type="text/javascript" src="{$smarty.const.SSL_SITE_URL}/includes/ajax/ajax.js"></script>
<SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript" src="{$smarty.const.SSL_SITE_URL}/scripts/popup.js"></script>
<SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript" src="{$smarty.const.SSL_SITE_URL}/modules/member/includes/reg_include.js"></script>
<!--<script type="text/javascript" src="{$smarty.const.SITE_URL}/includes/jquery/jquery-1.2.2.pack.js"></script>
<script type="text/javascript" src="{$smarty.const.SITE_URL}/includes/jquery/jquery.blockUI.js"></script>-->
...
function show_state(opt_name,country_id,state_name) 
{
	...
	{/literal}
	req1.open("POST", "{makeLink mod=member pg=ajax_state sslval=true}{/makeLink}&"+Math.random());
	{literal}
...
/*
	...
	req1.open("POST", "{makeLink mod=member pg=ajax_store sslval=true}act=reg_pack{/makeLink}&"+Math.random());
	{literal}
	req1.setRequestHeader("Content-Type","application/x-www-form-urlencoded; charset=UTF-8");
	req1.send(str);
}
...
function loadSub(reg_pack)
{
	...
	req1.open("POST", "{makeLink mod=member pg=ajax_store sslval=true}act=sub_pack{/makeLink}&"+Math.random());
	{literal}
	req1.setRequestHeader("Content-Type","application/x-www-form-urlencoded; charset=UTF-8");
	req1.send(str);
}
...
function validUname(uname)
{
	if (uname.length>4)
	{
		...
		req1.open("POST", "{makeLink mod=member pg=ajax_store sslval=true}act=valid_uname{/makeLink}&"+Math.random());
		{literal}
		req1.setRequestHeader("Content-Type","application/x-www-form-urlencoded; charset=UTF-8");
		req1.send(str);
	}
...
function _keyCheck2(e) {
	key = getKeyCode(e);
	//alert(key);
	if ( key==null || key==0 || key==8 || key==9 || key==13 || key==27 || key==32 )
		return true;
	else if ((key > 96 && key < 123) || (key > 47 && key < 58) || (key > 64 && key < 91) )
		return true;
	else
		return false;
}
...
function storeValues(){
	...
	var sub_pack 		= document.frmReg.sub_pack.value;
		...
		{/literal}
		req10.open("POST", "{makeLink mod=member pg=ajax_store sslval=true}act=store_reg_sess{/makeLink}&"+Math.random());
		{literal}
	...
	if(_var)
	{
		 if(document.getElementById('reg_amt') && document.getElementById('subpack_amt')  )
		 {
			...
			if(document.getElementById('tot_amt').value)
			{
			 ...
			 {/literal}
				var return_url= "{makeLink mod='member' pg='signup' sslval=true}act=payment_completed&surl="+store_name+"{/makeLink}";
			 {literal}
...
function loadSubsPackIds(sub_pack)
{
	...
	req1.open("POST", "{makeLink mod=member pg=ajax_store sslval=true}act=subs_pack_vals{/makeLink}&"+Math.random());
	{literal}
	req1.setRequestHeader("Content-Type","application/x-www-form-urlencoded; charset=UTF-8");
	req1.send(str);
...
{if $smarty.session.first_name eq ''}
  ...
  {if $smarty.session.last_name eq ''}
...
<input type="hidden" name="storeheading_valid" id="storeheading_valid" >
...
<div  >
  ...
  <tr>
    <td><a name="e1"></a><a class="bodytext" href="javascript:void(0);" onClick="window.open('{makeLink mod=cms pg=display sslval=true}data=faq&hval=y&print=y{/makeLink}','name','height=675,width=800,left=250,top=100,toolbar=no,scrollbars=yes');"><u>FAQ - Frequently Asked Questions:</u></a></td>
	 ...
	 {/if}
			...
			<div class="form_row_field">
					<div class="form_wrap" id="address1_left">
					    ...
					    <div class="form_field_wrap">
					    <input name="address1" id="address1" type="text" class="{$address1_class}"  value="{$address1_default}"  onBlur="javascript:hideTips('address1_holder');checkDefault(this.value,'address1','','form_field_wrap_input','form_field_wrap_input')"  onClick="javascript:changeDefault(this.value,'address1','','form_field_wrap_input','form_field_wrap_input');" onFocus="javascript:changeDefault(this.value,'address1','','form_field_wrap_input','form_field_wrap_input');showTips('address1_holder','address1_hint','address1_error','address1_left');" onPaste="return false" onDrop="return false" onDrag="return false" onkeypress="return _keyCheck2(event);"  />
					  </div>
					</div>
		 ...
		 <div class="form_row_field">
					<div class="form_wrap" id="address2_left">
					    ...
					    <div class="form_field_wrap">
					    <input name="address2" id="address2" type="text" class="{$address2_class}"  value="{$address2_default}" onBlur="javascript:hideTips('address2_holder');checkDefault(this.value,'address2','','form_field_wrap_input','form_field_wrap_input')"  onClick="javascript:changeDefault(this.value,'address2','','form_field_wrap_input','form_field_wrap_input');" onFocus="javascript:changeDefault(this.value,'address2','','form_field_wrap_input','form_field_wrap_input');showTips('address2_holder','address2_hint','address2_error','address2_left');"  onPaste="return false" onDrop="return false" onDrag="return false" onkeypress="return _keyCheck2(event);" />
					  </div>
					</div>
		 ...
		 <div class="form_row_field">
					<div class="form_wrap" id="city_left">
					    ...
					    <div class="form_field_wrap">
					    <input name="city" id="city" type="text" class="{$city_class}"  value="{$city_default}"  onBlur="javascript:hideTips('city_holder');checkDefault(this.value,'city','','form_field_wrap_input','form_field_wrap_input')"  onClick="javascript:changeDefault(this.value,'city','','form_field_wrap_input','form_field_wrap_input');" onFocus="javascript:changeDefault(this.value,'city','','form_field_wrap_input','form_field_wrap_input');showTips('city_holder','city_hint','city_error','city_left');" onPaste="return false" onDrop="return false" onDrag="return false" onkeypress="return _keyCheck2(event);"   />
					  </div>
					</div>
	...
	<div class="form_message_holder">
				 ...
				 <div class="form_row_field">
					<div class="form_wrap" id="telephone_left">
					    ...
					    <div class="form_field_wrap">
					    <input name="telephone" id="telephone" type="text" class="{$telephone_class}"  value="{$telephone_default}"   onBlur="javascript:hideTips('telephone_holder');checkDefault(this.value,'telephone','','form_field_wrap_input','form_field_wrap_input')"  onClick="javascript:changeDefault(this.value,'telephone','','form_field_wrap_input','form_field_wrap_input');" onFocus="javascript:changeDefault(this.value,'telephone','','form_field_wrap_input','form_field_wrap_input');showTips('telephone_holder','telephone_hint','telephone_error','telephone_left');" onPaste="return false" onDrop="return false" onDrag="return false" onkeypress="return _keyCheck2(event);"  />
					  </div>
					</div>
	...
	<div class="formbold_text form_height">Your Retail Store Information<br /><br /></div>
	 <div class="form_row_field">
					<div class="form_wrap" id="heading_left">
					    ...
					    <div class="form_field_wrap">
					    <input name="heading" id="heading" type="text" class="{$heading_class}"  value="{$heading_default}" onBlur="javascript:hideTips('heading_holder');checkDefault(this.value,'heading','','form_field_wrap_input','form_field_wrap_input');validStoreName(this.value);"  onClick="javascript:changeDefault(this.value,'heading','','form_field_wrap_input','form_field_wrap_input');" onFocus="javascript:changeDefault(this.value,'heading','','form_field_wrap_input','form_field_wrap_input');showTips('heading_holder','heading_hint','heading_error','heading_left');"  onPaste="return false" onDrop="return false" onDrag="return false" onkeypress="return _keyCheck2(event);"  />
					  </div>
					</div>
...
Enter your store name or business name above. Example: 'Mary's Personalized Gifts'. This name will be used in for email correspondence with your customers.<span class="form_hint-pointer">&nbsp;</span></span>					</div>
				 ...
				 <div class="clear"></div>
					...
					<div class="form_message_holder" id="store_name_holder">
						<span style="display:none;" class="form_hint" id="store_name_hint">The name you enter here will be used to create your new web-store address. You can enter your store name without spaces. <br />Example: If your business
and or store name is &quot;Mary&rsquo;s Gifts&quot;, you can enter &quot;marysgifts&quot;
here. NOTE: Do not enter &quot;http&quot; or &quot;www&quot; or &quot;.com&quot;
as these are not needed.<span class="form_hint-pointer">&nbsp;</span></span>					</div>
			<div class="form_message_holder">
				 ...
				 <div class="clear"></div>
				 <div style="margin-left:160px; width:500px;display:none"><span class="formsmall_link">{$smarty.const.SSL_SITE_URL}/<span id="div_store_name"></span></span></div>
...
Examples: Heading 1: 'Mary's Personalized Gifts', and Heading 2: 'Designed by You!'<span class="form_hint-pointer">&nbsp;</span></span>					</div>
				 ...
				 <div class="form_row_field">
					...
					<div class="form_name_wrap">Heading 2: *</div>
					    <div class="form_field_wrap">
					    <input name="heading2" id="heading2" type="text" class="{$heading2_class}"  value="{$heading2_default}"  onBlur="javascript:hideTips('heading2_holder');checkDefault(this.value,'heading2','','form_field_wrap_input','form_field_wrap_input')"  onClick="javascript:changeDefault(this.value,'heading2','','form_field_wrap_input','form_field_wrap_input');" onFocus="javascript:changeDefault(this.value,'heading2','','form_field_wrap_input','form_field_wrap_input');showTips('heading2_holder','heading2_hint','heading2_error','heading2_left');" onPaste="return false" onDrop="return false" onDrag="return false" onkeypress="return _keyCheck2(event);"  />
					  </div>
					</div>
...
<div class="form_message_holder">
  ...
  <tr>
    ...
    <td align="left" valign="top"><div id="totalblock" style="font-weight:bold; ">${$TOT_AMT|string_format:"%.2f"}</div></td>
				...
				<div class="form_row_field" style="display:none" id="chk_accept_left_error">
					<div class="form_wrap" id="promo_code_left" style=" width:560px">
						<div class="form_name_wrap">&nbsp;</div>
				      <div class="form_field_wrap" style=" width:400px">
				    <span style="font:normal 11px Verdana, Arial, Helvetica, sans-serif; color:#C4120E;">You must accept the terms of service to complete registration</span>
					</div>
                </div>
				</div>
				 <div class="clear"></div>
  ...
  -->
					...
					<div class="form_wrap">
						<div ></div>
				     <div class="" >{include file="`$smarty.const.SITE_PATH`/modules/member/tpl/retailar_signup_paypal.tpl}</div>
					</div>

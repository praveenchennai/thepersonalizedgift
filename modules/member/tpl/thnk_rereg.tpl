		...
		<table width="100%"  border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td colspan="2" align="center" valign="top"><table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
				  ...
				  <tr align="left">
                    <td height="18" colspan="6" class="bodytext_new" >{$MOD_VARIABLES.MOD_LABELS.LBL_WEB_STORE_LINK} &nbsp;&nbsp; <a href="{$smarty.const.SITE_URL}/{$SURL}" class="bodytext_new" target="_blank">{$smarty.const.SITE_URL}/{$SURL}</a></td>
                  </tr>
				   <tr align="left">
                    <td height="18" colspan="6" class="bodytext_new" >{$MOD_VARIABLES.MOD_LABELS.LBL_MANAGE_WEB_STORE} &nbsp;&nbsp; <a href="{$smarty.const.SITE_URL}/{$SURL}/manage" class="bodytext_new" target="_blank">{$smarty.const.SITE_URL}/{$SURL}/manage</a></td>
                  </tr>
				   <tr align="left">
                    <td height="18" colspan="6" class="styletext" >&nbsp;</td>
                 <!--  </tr>

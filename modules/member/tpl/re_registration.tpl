...
<div  >
  ...
  <tr>
    <td><a name="e1"></a><a class="bodytext" href="javascript:void(0);" onClick="window.open('{makeLink mod=cms pg=display}data=faq&hval=y&print=y{/makeLink}','name','height=675,width=800,left=250,top=100,toolbar=no,scrollbars=yes');"><u>FAQ - Frequently Asked Questions:</u></a></td>
...
Enter your store name or business name above. Example: 'Mary's Personalized Gifts'. This name will be used in for email correspondence with your customers.<span class="form_hint-pointer">&nbsp;</span></span>					</div>
			...
			<div class="form_message_holder">
				 ...
				 <div class="clear"></div>
				 <div style="margin-left:160px; width:500px"><span class="formsmall_link">{$smarty.const.SITE_URL}/<span id="div_store_name"></span></span></div>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >			 
	...
	<div>
				 <div style="float:left; "><img src="{$GLOBAL.tpl_url}/images/buttons/left.jpg" width="8" height="23"></div>
					<div class="button_mid"><a href="javascript:void(0);" onclick="validFields();"  class="button_hrf_class">Submit</a></div>

  ...
  <tr> 
    <td><table border=0 width=100% cellpadding="5" cellspacing="2"> 
        {if count($SESS_LIST) > 0}        <tr>
		  ...
		  <td nowrap class="naGridTitle" height="24" align="left" width="308">{makeLink mod=member pg=user orderBy="duration" display="Total Duration"}act=session{/makeLink}</td> 
        </tr>

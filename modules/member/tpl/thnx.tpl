...
<form name="frmReg" id="frmReg" method="post" action="" > 
		<table width="100%"  border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td height="45" colspan="2" align="left" valign="middle" class="greyboldext" >{$MOD_VARIABLES.MOD_LABELS.LBL_REGISTRATION_DETAILS}</td>
              </tr>
			   <tr>
              ...
              <tr>
                ...
                <td colspan="2" align="center" valign="top"><table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
				  ...
				  <tr align="left">
				   ...
				   <tr align="left">
				    <td height="18" colspan="6" class="bodytext_new"  >{$MOD_VARIABLES.MOD_LABELS.LBL_STORE_SUCCESSFULL_MSG}</td>
			      </tr>
				     <tr align="left">
				    <td height="18" colspan="6" class="bodytext"  >&nbsp;</td>
			      </tr>
				    ...
				    <tr align="left">
				    <td height="18" colspan="6" class="bodytext_new"  >{$MOD_VARIABLES.MOD_LABELS.LBL_STORE_ACTIVATION_LINK}</td>
			      </tr>
				  ...
				  <tr align="left">
                    <td height="18" colspan="6" class="bodytext_new" >{$MOD_VARIABLES.MOD_LABELS.LBL_WEB_STORE_LINK} &nbsp;&nbsp; <a href="{$smarty.const.SITE_URL}/{$smarty.request.surl}" class="bodytext_new" target="_blank">{$smarty.const.SITE_URL}/{$smarty.request.surl}</a></td>
                  </tr>
				   <tr align="left">
                    <td height="18" colspan="6" class="bodytext_new" >{$MOD_VARIABLES.MOD_LABELS.LBL_MANAGE_WEB_STORE} &nbsp;&nbsp; <a href="{$smarty.const.SITE_URL}/{$smarty.request.surl}/manage" class="bodytext_new" target="_blank">{$smarty.const.SITE_URL}/{$smarty.request.surl}/manage</a></td>
                  </tr>
				   <tr align="left">
                    <td height="18" colspan="6" class="styletext" >&nbsp;</td>
                  </tr>
				    <tr align="left">
                    <td height="18" colspan="6" class="bodytext_new" ><strong>{$MOD_VARIABLES.MOD_HEADS.HD_PAYMENT_DETAILS}</strong></td>
                  </tr>
				
				   <tr>
				    <td height="18" colspan="6" class="bodytext_new" align="left"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="21%">{$MOD_VARIABLES.MOD_LABELS.NAME}</td>
                        <td width="2%">&nbsp;</td>
                        <td width="77%">{$FIRST_NAME}&nbsp;{$LAST_NAME}</td>
                      </tr>
                      <tr>
                        <td>{$MOD_VARIABLES.MOD_LABELS.ITEM}</td>
                        <td>&nbsp;</td>
                        <td>{$ITEM_NAME}</td>
                      </tr>
					  <tr>
                        <td>{$MOD_VARIABLES.MOD_LABELS.LBL_AMOUNT}</td>
                        <td>&nbsp;</td>
                        <td>{$AMOUNT}</td>
                      </tr>
                    </table></td>

...
function pagesub()
	...
	if(chk(document.frmReg))
		...
		{/literal}
		document.frmReg.action='{makeLink mod=member pg=register}act=billing_det{/makeLink}';
		{literal}
...
<SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
	...
	var msgs=new Array('Billing First Name','Billing Last Name','Billing Address','Billing Zip/Postal Code','Billing Country');
...
<div style="width:700px; padding: 5px; margin: 0px auto;">
	<div class="greyboldext">{$MOD_VARIABLES.MOD_HEADS.HD_BILL_DETAILS}</div>
	<br>
	...
	<div class="bodytext">
		...
		<span><input name="address1" type="text" class="input" id="address1" value="{$BILLING_ADDRESS.address1}" size="30" /></span>
	</div><br>
	<div class="bodytext">
		<span>&nbsp;</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

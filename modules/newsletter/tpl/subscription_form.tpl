...
<table border=0 width=80% cellpadding=5 cellspacing=1 class=naBrDr> 
  <form method="POST" name="subFrm" action="" style="margin: 0px;"> 
    <tr> 
	  ...
	  <td align="right"><a href="{makeLink mod="newsletter" pg="subscription"}act=list{/makeLink}">List Subscription</a></td> 
    </tr> 
    {if isset($MESSAGE)}
    <tr class=naGrid2>
    ...
    <tr class=naGrid2> 
      ...
      <td width=1% valign=top>:</td> 
      <td width="59%"><input type="text" name="email" value="{$SUBSCRIPTION.email}" class="formText" size="30" maxlength="255" ></td> 
    </tr>
    <tr class="naGrid1">

...
<table border=0 width=80% cellpadding=5 cellspacing=1 class=naBrDr> 
 ...
 <tr> 
	  ...
	  <td align="left"><input name="redirect_url"  type="text" class="input" id="redirect_url" value="{if $REURL eq '' } http://{else}{$REURL}{/if}"  style="width:269px; " /> &nbsp;&nbsp;&nbsp;&nbsp;<!-- <a href="#" onClick="showPopup('forward_masking');">What is this?</a>  --></td>
	</tr>
...
If your existing domain URL is set up with a DNS A (host) record that points to your registrar's IP address, that <strong>A (host) record must be removed</strong>. <br /></span></font><br /><font size="2" face="Arial"><span style="font-size: 10pt; font-family: Arial;">2. The below CNAME records must be created as specified or some elements of your web-store will not function properly.<br /></span></font></p>
	...
	<font size="2" face="Arial"><span><strong><span>CNAME records to create: </span></strong>(provide this information to your domain registrar)<br />1. Alias Name: <strong> {$ALIAS}</strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;              Pointing To Host Name: <strong>thepersonalizedgift.com</strong><br />
	 2. Alias Name: <strong>{$DOMAIN}</strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   Pointing To Host Name: <strong>thepersonalizedgift.com</strong>   </span></font>
	</td>
	</tr>

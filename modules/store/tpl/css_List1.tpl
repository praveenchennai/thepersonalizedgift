...
<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0" class=naBrdr>
       <tr>
                         ...
                         <tr>
                           <td align="center" valign="baseline">
						    <a href="#" onClick="return showContent({$css->temp_id})"><img src="{$GLOBAL.tpl_url}/images/btn_preview.gif">&nbsp;</a>
						   	<a class="linkOneActive" href="{makeLink mod=store pg=index}act=assign_css&css_id={$css->temp_id}&store_id={$STORE_ID}{/makeLink}"><img src="{$GLOBAL.tpl_url}/images/btn_select.gif"></a>
						   </td>
                         </tr>
                       </table>
					   </td>
        ...
        <td width="10" align="center" valign="top">&nbsp;&nbsp;<iframe  id="if_css"  height="400" width="350" src="{makeLink mod=store pg=index}act=showimage{/makeLink}&css_id={$STORE_DETAILS.template_id}" frameborder="0"></iframe></td>			

...
If your existing domain URL is set up with a DNS A (host) record that points to your registrar's IP address, that <strong>A (host) record must be removed</strong>. <br /></span></font><font size="2" face="Arial"><span style="font-size: 10pt; font-family: Arial;">2. The below CNAME records must be created as specified or some elements of your web-store will not function properly.<br /></span></font></p>
	...
	<font size="2" face="Arial"><span><strong><span>CNAME records to create: </span></strong>(provide this information to your domain registrar)<br />1. Alias Name: <strong><span id="div_store_name">{$ALIAS}</span></strong>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	             Pointing To Host Name: <strong>thepersonalizedgift.com</strong><br />
	<div id="div_dom"  {if $ALIAS eq "www"} style="display:block" {else} style="display:none;" {/if}> 2. Alias Name: <strong><span id="div_dom_name">{$DOMAIN}</span></strong>   
	 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	
	 Pointing To Host Name: <strong>thepersonalizedgift.com</strong>  </div></font>
	</td>
	<tr class="naGrid2">
	    <td colspan="2">&nbsp;</td>

...
<table border=0 width=80% cellpadding=5 cellspacing=1 class=naBrDr> 
 ...
 <tr class="naGrid1" > 
      <td valign=top width=30% align="right"><strong><span>Redirect URL:</span></strong></td> 
	  ...
	  <td  align="left"><input name="redirect_url"  type="text" class="input" id="redirect_url" value="{if $REURL eq '' } http://{else}{$REURL}{/if}"  style="width:269px; "  onkeypress="return _keyCheck(event);"  autocomplete="off"  onKeyUp="fillText(this.value);" /> &nbsp;&nbsp;&nbsp;&nbsp;<!-- <a href="#" onClick="showPopup('forward_masking');">What is this?</a>  --></td>
		...
		<tr class="naGrid2" ><td colspan="3">
				<p><span ><strong><span ></span></strong>  </span><span >Enter your redirect URL in the format <em>http://www.yoursite.com</em></span></p><p><span ></span></font><strong><span style="font-weight: bold;  ">How to point your URL to your web-store:</span></font></strong><font ><span ><br /></span></font><font size="2"><span >To
...
CNAME records explained below.</span></font></p><p><font ><span ><strong><span style="font-weight: bold;"></span></strong><strong><span style="font-weight: bold;">Important Note:</span></strong> Some domain registrars (including godaddy.com) utilize a <em>shortcut</em>
